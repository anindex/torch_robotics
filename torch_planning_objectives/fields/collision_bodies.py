...
class PandaSphereDistanceField(SphereDistanceField):
    ...
    def __init__(self, batch_size=1, device='cpu'):
        ...
        super(PandaSphereDistanceField, self).__init__(robot_collision_params, batch_size=batch_size, device=device)
...
class TiagoSphereDistanceField(SphereDistanceField):
    ...
    def __init__(self, batch_size=1, device='cpu'):
        ...
        super(TiagoSphereDistanceField, self).__init__(robot_collision_params, batch_size=batch_size, device=device)
